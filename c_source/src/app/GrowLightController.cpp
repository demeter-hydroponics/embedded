...
GrowLightController::GrowLightController(TimeServer& timeServer, BaseGrowLightSection* growLightSections, size_t numGrowLightSections, MessageQueue<CommManagerQueueData_t>& msgQueue, MessageQueue<SetPPFDReferenceCommand>& ppfdCommandQueue)
...
void GrowLightController::setPPFDReference(float ppfdReference) {
    ppfdReference_ = ppfdReference;
}
